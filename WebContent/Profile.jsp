...
<header>
 ...
 <div class="content" >
 <h2  align="center"> <b>My Profile</b> </h2><br>
 <form action="update"  class="form" method="POST"  >
  ...
  <br>
    ...
    <input type="checkbox" name="" value =""><span><b>Yes,I guarantee the above information is true..</b></span>
    <br>
	<br>
	
	
   <button class="btn btn1" type="submit">Update Details</button> <br><br><br>
	<p class="phara" id="p2"><mark>If you need to change your information, change it again correctly.<br><br>
          </mark></p>
	
	
	<img src="images/profile.png" class=image1>
